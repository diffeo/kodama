 ...
 *
 * The return value is dendrogram that the caller is responsible for freeing.
 ...
 *
 * Note that it is an unchecked runtime error to provide a matrix with a length
 * that is consistent with the number of observations.
 */
